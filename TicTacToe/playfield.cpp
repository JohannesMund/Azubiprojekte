...
void PlayField::checkWinner()
{
    ...
    for (int line = 0; line <= 2; line++) {
        if (_grid[line][0] == _grid[line][1] && _grid[line][0] == _grid[line][2] && _grid[line][0] != PlayerManagement::PlayerManagement::none) {
    ...
    for (int col = 0; col <= 2; col++) {
        if (_grid[0][col] == _grid[1][col] && _grid[0][col] == _grid[1][col] && _grid[0][col] != PlayerManagement::none) {
