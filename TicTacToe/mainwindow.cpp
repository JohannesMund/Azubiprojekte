...
void MainWindow::newTurn()
{
    ...
    ui->lbOut->setText(QString("Spieler %1 ist dran").arg(_playerManagement.currentPlayerText()));
}
...
void MainWindow::haveWinner(const PlayerManagement::Player & p)
{
    ...
    {
        QMessageBox::information(this, "Spielende", QString("Spieler %1 gewinnt").arg(PlayerManagement::playerToText(p)));
    }
